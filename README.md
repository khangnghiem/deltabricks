...
The 'deltabricks' project was generated by using the default-python template.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] deltabricks_job` to your workspace.
...
3. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/deltabricks.job.yml). The schedule
